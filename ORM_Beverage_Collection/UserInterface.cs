...
namespace ORM_Beverage_Collection
{
    class UserInterface
    {
        ...
        */
        ...
        // Get information for the item to be removed
        public string GetRemoveItemInformation()
        {
            Console.WriteLine();
            Console.WriteLine("Enter the Id of the item you would like to remove");
            Console.Write("> ");
            return GetSelection();
        }
        // Get the id for the item to be updated
        ...
        // get the information for the item to be updated
        public string[] GetUpdatedItemInformation()
        {
            string name = this.GetUpdatedStringField("Name");
            string pack = this.GetUpdatedStringField("Pack");
        ...
        // Display error message for removing items that dont exist
        public void DisplayRemoveItemError() 
        {
            Console.WriteLine();
            Console.ForegroundColor = ConsoleColor.Red;
            Console.WriteLine("No Item With That Id Exists To Be Removed");
            Console.ForegroundColor = ConsoleColor.Gray;
        }
        // Display error message for updating item id
        public void DisplayFindUpdateItemError()
        {
            Console.WriteLine();
            Console.ForegroundColor = ConsoleColor.Red;
            Console.WriteLine("No Item With That Id Exists To Be Updated");
            Console.ForegroundColor = ConsoleColor.Gray;
        }
        ...
        */
        ...
        // Get a valid string field from the console
        private string GetUpdatedStringField(string fieldName)
        {
            Console.WriteLine("What is the Item's {0}. Leave blank to avoid changes.", fieldName);
            return GetSelection();
        }
        ...
        {
            Console.WriteLine("Should the Item be {0} (y/n). Leave blank to avoid changes.", fieldName);
            string input = null;
            bool value = false;
            bool valid = false;
            while (!valid)
